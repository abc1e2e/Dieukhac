...
@section('content')
    <div class="container">
        <p class="p_new_1">Trang chủ <img src="../images/arrow-right-double-sharp.png" alt="arrow-right-double-sharp"> Danh sách dự án <img src="../images/arrow-right-double-sharp.png" alt="arrow-right-double-sharp"> Chi tiết dự án</p>
    </div>
   <div class="container">

...
@section('content')
    ...
    <div class="container_question">
        <ol class="menu_ol">
            ...
            <li>
                <p class="question_cs">Chất liệu chính mà công ty cổ phần ứng dụng điêu khắc việt nam sử dụng để chế tác điêu khắc là gì?<img src="images/plus-sign.png" alt="plus-sign.png">  </p>
            </li>
            <li>
                <p class="question_cs">Chất liệu chính mà công ty cổ phần ứng dụng điêu khắc việt nam sử dụng để chế tác điêu khắc là gì?<img src="images/plus-sign.png" alt="plus-sign.png"></p>
            </li>
